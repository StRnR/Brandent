...
public class ModelConverter {
    ...
    public static Clinic[] clinicsToSync(com.pixium.clinitick.db.entities.Clinic[] dbClinics) {
    ...
    public static com.pixium.clinitick.db.entities.Clinic[] clinicsFromSync(Clinic[] clinics) {
        com.pixium.clinitick.db.entities.Clinic[] res =
                new com.pixium.clinitick.db.entities.Clinic[clinics.length];
    ...
    public static Patient[] patientsToSync(com.pixium.clinitick.db.entities.Patient[] dbPatients) {
    ...
    public static com.pixium.clinitick.db.entities.Patient[] patientsFromSync(Patient[] patients) {
        com.pixium.clinitick.db.entities.Patient[] res =
    ...
    public static Appointment[] appointmentsToSync(String[] clinicUuids, String[] patientUuids
            , com.pixium.clinitick.db.entities.Appointment[] dbAppointments) {
    ...
    public static com.pixium.clinitick.db.entities.Appointment[] appointmentsFromSync(int[] clinicIds
            , int[] patientIds, Appointment[] appointments) throws ParseException {
        com.pixium.clinitick.db.entities.Appointment[] res =
    ...
    public static Finance[] financesToSync(com.pixium.clinitick.db.entities.Finance[] dbFinances) {
    ...
    public static com.pixium.clinitick.db.entities.Finance[] financesFromSync(Finance[] finances)
            throws ParseException {
        com.pixium.clinitick.db.entities.Finance[] res =
                new com.pixium.clinitick.db.entities.Finance[finances.length];
        for (int i = 0; i < finances.length; i++) {
            res[i] = new com.pixium.clinitick.db.entities.Finance(ActiveUser.getInstance().getId()
