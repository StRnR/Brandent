...
import com.brandent.clinitick.api.repos.SyncRepository;
...
import com.brandent.clinitick.db.repos.TaskRepository;
...
public class IntroViewModel extends AndroidViewModel {
    ...
    public int[] getAppointmentClinicForIds(com.brandent.clinitick.api.models.Appointment[] appointments)
    ...
    public int[] getTaskClinicForIds(com.brandent.clinitick.api.models.Task[] tasks)
            throws ExecutionException, InterruptedException {
    ...
    public int[] getPatientForIds(com.brandent.clinitick.api.models.Appointment[] appointments)
            throws ExecutionException, InterruptedException {
        int[] res = new int[appointments.length];
        for (int i = 0; i < appointments.length; i++) {
