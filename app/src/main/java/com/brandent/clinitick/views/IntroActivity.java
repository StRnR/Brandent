...
import com.brandent.clinitick.ModelConverter;
...
import com.brandent.clinitick.viewmodels.IntroViewModel;
...
public class IntroActivity extends AppCompatActivity {
    ...
    public void sync(Dentist dentist) {
        com.brandent.clinitick.db.entities.Appointment[] toSyncAppointments;
        com.brandent.clinitick.db.entities.Task[] toSyncTasks;
        try {
            ...
            toSyncAppointments = new com.brandent.clinitick.db.entities.Appointment[0];
            e.printStackTrace();
        }
        ...
        try {
            ...
            toSyncTasks = new com.brandent.clinitick.db.entities.Task[0];
            e.printStackTrace();
        }
